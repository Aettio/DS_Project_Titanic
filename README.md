...
'*' Во время работы над проектом я дополнительно сохранял новые "чистые" сеты (Без всего что было для меня лишним) которые я не загружал на Git, так как по сути они были сделаны для моего личного удобства.
