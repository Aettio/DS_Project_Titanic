...
Нужно было проверить данную коррелицию, так как она у меня вызывала больше всего вопросов. В последствии я всё таки её обнаружил, хоть и пришлось поиграть с разными графиками.
